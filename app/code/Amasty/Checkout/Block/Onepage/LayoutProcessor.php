...
class LayoutProcessor implements LayoutProcessorInterface
{
    ...
    private function processMultipleShippingAddress()
    {
        if ($this->checkoutConfig->getMultipleShippingAddress() && $this->customerSession->isLoggedIn()) {
            ...
            $addressList = $this->walker->getValue('{SHIPPING_ADDRESS}.>>.address-list');

            $addressList['component'] = 'Amasty_Checkout/js/view/shipping-address/shipping-address';
            $addressList['provider'] = 'checkoutProvider';
            $addressList['deps'] = 'checkoutProvider';
            $addressList['dataScopePrefix'] = 'shippingAddress';
