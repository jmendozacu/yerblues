...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Impac_Tntalpha3::Valoresoficina')
            ->addBreadcrumb(__('Impac Tntalpha3'), __('Impac Tntalpha3'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('valoresoficina', $model);
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Editar Costo de Envío') : __('Nuevo Costo de Envío'),
            $id ? __('Editar Costo de Envío') : __('Nuevo Costo de Envío')
        );
        $resultPage->getConfig()->getTitle()->prepend($id ? __('Editar Costo de Envío') : __('Nuevo Costo de Envío'));
